...
from gitlablib import get_version
...
PYPI_PACKAGE_NAME = 'gitlablib'
PROJECT_SHORT_DESC = 'An unofficial Python 3 client for the GitLab API'
...
#ENTRY_POINTS = {
#  'console_scripts': [
#      'gitlab2notion = gitlab2notion.core:main',
#  ],
#}
